#' This function creates a graph that plots the estimated voteshare for each bloc
#' as a function of the latent left right position as well as the distribution
#' of the latent outcomes
ppc_party_positions_density <- function(fit, bloc_vector, data_list){
  ...
  out <- lapply(sample(1:1800, 100), function(jj){
